...
def maintest():
  ...
  # Test measures
  for i in [M1,M2]:
    print(pc.LZc(i,norm="max",concat="space",threshold="median",shuffles=5,ea="mean"))
    print(pc.ACE(i,norm="max",threshold="median",shuffles=1,ea="mean"))
    print(pc.SCE(i,norm="max",threshold=0.8,shuffles=1,ea="mean",ca="mean"))
    print(pc.centrality(i,ea="mean",ca="mean"))
